# VPC Module for Secure Healthcare Data Pipeline
# Implements multi-AZ, private subnet architecture for PHI data protection
...
# Public Subnets (for NAT Gateway and Load Balancers only)
resource "aws_subnet" "public" {
  ...
  map_public_ip_on_launch = false  # HIPAA best practice
...
# Private Subnets (for Lambda, ECS, RDS - PHI data processing)
...
# VPC Endpoints for AWS Services (reduce data transfer costs and improve security)
